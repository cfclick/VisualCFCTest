...
<cfset nextUrl = new Framework.Util().generateURL("WSlayoutpage.cfm")>
...
<cfoutput>
	<response showresponse="true">
		<ide url="#nextUrl#">
			<dialog title="Visual Unit Test for ColdFusion WebServices" image="handlers/assets/vcfc-logo.png" width="1200" height="100%"/>
		</ide>
	</response>
</cfoutput>