...
<cftry>
	...
	<cfset initFuncArg = []/>
	<cfset funcArg = []/>
	<cfset functions = session.remoteFunctions/>
	...
	<cfoutput>
		...
		<cfif isdefined("form.submit")>
			...
			<cfset wsproxy = createobject("webservice",session.wsString)/>

			<cfset result = util.InvokeTheMethodByInitObject(wsproxy, form.funcName, funcArg, form)/>
